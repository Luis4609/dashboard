...
describe('DailyChats e2e test', () => {
  ...
  const dailyChatsSample = {
    totalDailyReceivedChats: 9577,
    totalDailyConversationChatsTimeInMin: 27212,
    totalDailyAttendedChats: 18324,
    totalDailyMissedChats: 19539,
    avgDailyConversationChatsTimeInMin: 11063.85,
  };
  ...
  describe('new DailyChats page', () => {
    ...
    it('should create an instance of DailyChats', () => {
      cy.get(`[data-cy="totalDailyReceivedChats"]`).type('5625');
      cy.get(`[data-cy="totalDailyReceivedChats"]`).should('have.value', '5625');

      cy.get(`[data-cy="totalDailyConversationChatsTimeInMin"]`).type('27527');
      cy.get(`[data-cy="totalDailyConversationChatsTimeInMin"]`).should('have.value', '27527');

      cy.get(`[data-cy="totalDailyAttendedChats"]`).type('17697');
      cy.get(`[data-cy="totalDailyAttendedChats"]`).should('have.value', '17697');

      cy.get(`[data-cy="totalDailyMissedChats"]`).type('22472');
      cy.get(`[data-cy="totalDailyMissedChats"]`).should('have.value', '22472');

      cy.get(`[data-cy="avgDailyConversationChatsTimeInMin"]`).type('2237.73');
      cy.get(`[data-cy="avgDailyConversationChatsTimeInMin"]`).should('have.value', '2237.73');
