  ...
  return (
    <div>
      <h2 id="daily-chats-heading" data-cy="DailyChatsHeading">
        <Translate contentKey="dashboardApp.dailyChats.home.title">Daily Chats</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dashboardApp.dailyChats.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/daily-chats/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dashboardApp.dailyChats.home.createLabel">Create new Daily Chats</Translate>
          </Link>
        </div>
      </h2>
        ...
        {dailyChatsList && dailyChatsList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dashboardApp.dailyChats.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('day')}>
                  <Translate contentKey="dashboardApp.dailyChats.day">Day</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('day')} />
                </th>
                <th className="hand" onClick={sort('totalDailyReceivedChats')}>
                  <Translate contentKey="dashboardApp.dailyChats.totalDailyReceivedChats">Total Daily Received Chats</Translate>{' '}
                ...
                <th className="hand" onClick={sort('totalDailyConversationChatsTimeInMin')}>
                  <Translate contentKey="dashboardApp.dailyChats.totalDailyConversationChatsTimeInMin">
                ...
                <th className="hand" onClick={sort('totalDailyAttendedChats')}>
                  <Translate contentKey="dashboardApp.dailyChats.totalDailyAttendedChats">Total Daily Attended Chats</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('totalDailyAttendedChats')} />
                </th>
                <th className="hand" onClick={sort('totalDailyMissedChats')}>
                  <Translate contentKey="dashboardApp.dailyChats.totalDailyMissedChats">Total Daily Missed Chats</Translate>{' '}
                ...
                <th className="hand" onClick={sort('avgDailyConversationChatsTimeInMin')}>
                  <Translate contentKey="dashboardApp.dailyChats.avgDailyConversationChatsTimeInMin">
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/daily-chats/${dailyChats.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dashboardApp.dailyChats.home.notFound">No Daily Chats found</Translate>
            </div>
          )
        )}
      </div>
