...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUMBEROFHOURS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NUMBEROFHOURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NUMBEROFHOURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NUMBEROFHOURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NUMBEROFHOURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NUMBEROFHOURS actions', async () => {
      const expectedActions = [
        {
