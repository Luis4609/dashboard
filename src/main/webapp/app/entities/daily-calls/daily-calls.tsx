  ...
  return (
    <div>
      <h2 id="daily-calls-heading" data-cy="DailyCallsHeading">
        <Translate contentKey="dashboardApp.dailyCalls.home.title">Daily Calls</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="dashboardApp.dailyCalls.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/daily-calls/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
        ...
        {dailyCallsList && dailyCallsList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="dashboardApp.dailyCalls.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('day')}>
                  <Translate contentKey="dashboardApp.dailyCalls.day">Day</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('day')} />
                </th>
                <th className="hand" onClick={sort('totalDailyReceivedCalls')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyReceivedCalls">Total Daily Received Calls</Translate>{' '}
                ...
                <th className="hand" onClick={sort('totalDailyAttendedCalls')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyAttendedCalls">Total Daily Attended Calls</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('totalDailyAttendedCalls')} />
                </th>
                <th className="hand" onClick={sort('totalDailyMissedCalls')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyMissedCalls">Total Daily Missed Calls</Translate>{' '}
                ...
                <th className="hand" onClick={sort('totalDailyReceivedCallsExternalAgent')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyReceivedCallsExternalAgent">
                ...
                <th className="hand" onClick={sort('totalDailyAttendedCallsExternalAgent')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyAttendedCallsExternalAgent">
                ...
                <th className="hand" onClick={sort('totalDailyReceivedCallsInternalAgent')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyReceivedCallsInternalAgent">
                ...
                <th className="hand" onClick={sort('totalDailyAttendedCallsInternalAgent')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyAttendedCallsInternalAgent">
                ...
                <th className="hand" onClick={sort('totalDailyCallsTimeInMin')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyCallsTimeInMin">Total Daily Calls Time In Min</Translate>{' '}
                ...
                <th className="hand" onClick={sort('totalDailyCallsTimeExternalAgentInMin')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyCallsTimeExternalAgentInMin">
                ...
                <th className="hand" onClick={sort('totalDailyCallsTimeInternalAgentInMin')}>
                  <Translate contentKey="dashboardApp.dailyCalls.totalDailyCallsTimeInternalAgentInMin">
                ...
                <th className="hand" onClick={sort('avgDailyOperationTimeExternalAgentInMin')}>
                  <Translate contentKey="dashboardApp.dailyCalls.avgDailyOperationTimeExternalAgentInMin">
                ...
                <th className="hand" onClick={sort('avgDailyOperationTimeInternalAgentInMin')}>
                  <Translate contentKey="dashboardApp.dailyCalls.avgDailyOperationTimeInternalAgentInMin">
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/daily-calls/${dailyCalls.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dashboardApp.dailyCalls.home.notFound">No Daily Calls found</Translate>
            </div>
          )
        )}
      </div>
