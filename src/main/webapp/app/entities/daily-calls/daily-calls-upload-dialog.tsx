...
export const dailyCallsUploadDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      <ModalHeader toggle={handleClose} data-cy="dailyCallsUploadDialogdailyCallsUploadDialoHeadingHeading">
        <Translate contentKey="entity.delete.title">Upload new excel file</Translate>
      </ModalHeader>
      <ModalBody id="dashboardApp.dailyCalls.delete.question">
        <Translate contentKey="dashboardApp.dailyCalls.delete.question" interpolate={{ id: dailyCallsEntity.id }}>
...
export default dailyCallsUploadDialog;
